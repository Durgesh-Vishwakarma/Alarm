        ...
        <Animated.View entering={FadeInDown.duration(450)} style={styles.content}>
          ...
          <View style={[styles.card, { backgroundColor: theme.card, borderColor: theme.cardBorder }]}>
            ...
            <View style={styles.row}>
              ...
              <View style={styles.copy}>
                <Text style={[styles.label, { color: theme.textPrimary }]}>Exact alarms</Text>
                <Text style={[styles.value, { color: exactAlarmGranted ? theme.primary : theme.textMuted }]}>
                  {exactAlarmGranted ? "Granted ✓" : "Required"}
                </Text>
              </View>
            </View>
            ...
            <View style={styles.row}>
              <View style={[styles.iconShell, { backgroundColor: theme.primaryLight }]}>
                <Ionicons name="battery-charging" size={20} color={theme.primary} />
              </View>
              <View style={styles.copy}>
                <Text style={[styles.label, { color: theme.textPrimary }]}>Battery optimization</Text>
                <Text
                  style={[
                    styles.value,
                    { color: batteryOptimizationGranted ? theme.primary : theme.textMuted },
                  ]}
                >
                  {batteryOptimizationGranted ? "Ignored ✓" : "Disable for reliability"}
                </Text>
              </View>
            </View>
          </View>
